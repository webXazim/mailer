...
export const suppressionFixtures: Suppression[] = [
  { id: 'sup_1', email: 'jordan@northstar.io', domain: 'mail.acme.dev', reason: 'Bounced', detail: 'Hard bounce', source: 'SMTP feedback', added: '2 min ago' },
  ...
  { id: 'sup_4', email: 'team@northstar.io', domain: 'mail.acme.dev', reason: 'Bounced', detail: 'Hard bounce', source: 'SMTP feedback', added: 'Aug 14, 2026' }
]
