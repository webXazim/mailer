    ...
    <section className="public-hero">
      ...
      <div className="public-hero__copy">
        ...
        <div className="public-hero__actions">
          <button className="public-button public-button--primary" onClick={createAccount}>{signedIn ? 'Open CS Mailer' : 'Create account'} <ArrowRight size={17} /></button>
