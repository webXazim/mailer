...
for name in POSTGRES_PASSWORD NATS_PASSWORD WEBHOOK_SIGNING_MASTER_KEY; do
...
ln "$temporary" .env
echo 'Created .env with three independent local secrets. Fill in the credentials at the top, then run: sh manage deploy'
