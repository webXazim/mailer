...
export type Session = { user: { id: string; name: string; email: string; role: string }; workspace: { id: string; name: string; production_enabled: boolean; sending_paused: boolean; sending_pause_reason?: string | null; usage: { sent: number; limit: number } } }
export type Domain = { id: string; domain: string; status: string; provider: string; dns_automation: string[]; records: { record_type: string; name: string; value: string; required: boolean; status: string; last_checked_at?: string }[] }
